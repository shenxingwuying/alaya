...
inline void HealthResponse::clear_health() {
  if (health_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    health_->clear();
  }
  clear_has_health();
}
...
inline ::std::string* HealthResponse::release_health() {
  ...
  if (health_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    health_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
...
inline void StatResponse::clear_server_start_time() {
  if (server_start_time_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
...
inline ::std::string* StatResponse::release_server_start_time() {
  ...
  if (server_start_time_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    server_start_time_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
